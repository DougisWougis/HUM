...
namespace HUM {
    ...
    struct AudioBuffer {
        ...
        int sample_rate = 44100; // ADD THIS LINE: Default to standard CD-quality audio
    };
    ...
    struct ChromagramMatrix {
        ...
        std::vector<int> bass_root_bins; // ADD THIS: Holds the integer root (0-11) or -1 for silence
    };
